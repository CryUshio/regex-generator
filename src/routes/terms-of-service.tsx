...
export default function TermsOfSerice() {
  return (
    <article class="prose mx-auto py-16 max-w-3xl text-gray-950 textcolor-primary p-5">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            &quot;Our&quot; in this Agreement) refers to Regex Generator AI.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            <a href="https://www.freeprivacypolicy.com/free-terms-and-conditions-generator/" target="_blank">
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Regex Generator AI, accessible from{' '}
            <a href="https://regex-generator-ai.com" rel="external nofollow noopener" target="_blank">
              https://regex-generator-ai.com
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: ushio.cry@gmail.com</li>
      </ul>
    </article>
  );
}
